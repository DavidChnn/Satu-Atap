    ...
    <body class="min-h-screen bg-gradient-to-b from-[#0077C0] to-[#003C60]">
        ...
        <div class="bg-white p-8 mx-4 md:mx-16 lg:mx-24 rounded-xl mb-24">
            ...
            <div id="file-input-container">
                <p class="text-lg px-12 ">Kartu Keluarga</p>
                @include('component/form/baseForm')

                <p class="text-lg px-12 ">NPWP</p>
                @include('component/form/baseForm')
            ...
            <div class="container py-6 px-10 mx-0 min-w-full flex flex-col items-center">
                <a href="{{ route('inputFormAfter') }}" class="text-lg bg-[#0077C0] text-white hover:bg-gradient-to-r hover:from-[#0077C0] hover:to-[#373390] font-bold py-4 px-36 mt-3 rounded-2xl">Submit</a>
            </div>
        </div>
